    ...
    <NavTray>
      <NavExtension activeDefault="shoes-and-accesories">
        <NavExtension.Links>
          ...
          <NavExtension.Link to="/plus-sizes">Plus Sizes</NavExtension.Link>

          <NavExtension.Link to="/promotion">Promotion</NavExtension.Link>

          <NavExtension.Link to="/collections">Collections</NavExtension.Link>
        </NavExtension.Links>

        {/* NAVIGATION SUB-LINKS */}
        <NavExtension.SubLinks name="featured">
          <NavSubLinks links={TERTIARY_LINKS['featured-women']}>
            FEATURED
          </NavSubLinks>
        </NavExtension.SubLinks>

        <NavExtension.SubLinks name="western-collection">
          <NavSubLinks links={TERTIARY_LINKS['western-collection-women']}>
            WESTERN <br /> COLLECTION
          </NavSubLinks>
        </NavExtension.SubLinks>

        <NavExtension.SubLinks name="clothing">
          <NavSubLinks links={TERTIARY_LINKS['clothing-women']}>
            CLOTHING
          </NavSubLinks>
        </NavExtension.SubLinks>

        <NavExtension.SubLinks name="shoes-and-accesories">
          <NavSubLinks links={TERTIARY_LINKS['shoes-and-accessories-women']}>
